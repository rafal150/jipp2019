...
namespace Converter
{
    ...
    public partial class App : Application
    {
        ...
        private static IContainer BuildContainer()
        {
            ...
            {
                containerBuilder.RegisterType<ResultAzureRepository>().As<ICalculationResultRepository>();
            }
            else
            {
                containerBuilder.RegisterType<ResultSqlRepository>().As<ICalculationResultRepository>();
            }
