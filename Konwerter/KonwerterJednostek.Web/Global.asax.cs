...
namespace KonwerterJednostek.Web
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        private static Autofac.IContainer BuildContainer()
        {
            ...
            containerBuilder.RegisterType<KonwerterSerwisy>();

            var assembly = typeof(KonwerterSerwisy).Assembly;
            containerBuilder.RegisterAssemblyTypes(assembly)
                .Where(t => t.Name.StartsWith("Konwerter")).AsImplementedInterfaces().AsSelf();
        ...
        private static void RegisterPlugins(ContainerBuilder containerBuilder)
        {
            ...
            {
                containerBuilder.RegisterAssemblyTypes(assembly).Where(t => t.Name.StartsWith("Konwerter")).AsImplementedInterfaces();
            }
        }
    }
}
