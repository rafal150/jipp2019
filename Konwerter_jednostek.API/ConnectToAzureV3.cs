...
{
    public class ConnectToAzureV3
    {
        private CloudTable table;

        public ConnectToAzureV3()
        {
        ...
        public async Task<IEnumerable<Statystyka>> PobierzStatystykiAsync()
        {
            TableQuery<EntityStatystyka> query = new TableQuery<EntityStatystyka>();

            return (await table.ExecuteQuerySegmentedAsync(query,null).ConfigureAwait(false)).Select(obj => 
