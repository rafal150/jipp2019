...
namespace KonwerterZSQLiAZUREiPLUGIN
{
    ...
    public partial class App : Application
    {
        ...
        private static IContainer BuildContainer()
        {
            ...
            {
                containerBuilder.RegisterType<StatystykiAzure>().As<ADDStat>();
            }
            else
            {
                containerBuilder.RegisterType<SQL>().As<ADDStat>();
            }

            containerBuilder.RegisterType<MainWindow>();
            containerBuilder.RegisterType<Konwerter>();
        ...
        private static void RegisterPlugins(ContainerBuilder containerBuilder)
        {
            ...
            var assemblies = Directory.GetFiles(pluginDirectory, "Konwerter.SDK.dll").Select(Assembly.LoadFrom).ToList();
