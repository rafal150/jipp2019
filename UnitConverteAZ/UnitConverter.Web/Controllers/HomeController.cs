...
namespace UnitConverter.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILifetimeScope scope, IStatisticRepository statisticsRepository, ConverterService convertersService)
        {
        ...
        {
            ViewBag.Message = "Moja aplikacja AZ.";
