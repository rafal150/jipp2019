   ...
   public  class TempConverter : IConverter
    {
        ...
        {
            static decimal F2C(decimal fahrenheit) =>
           (fahrenheit - 32.0M) / 1.8M;
            static decimal C2F(decimal celsius) =>
               (celsius * 1.8M) + 32.0M;

            static decimal C2K(decimal celsius) =>
              celsius + 273.15M;

            static decimal K2C(decimal kelvin) =>
              kelvin - 273.15M;

            static decimal C2R(decimal celsius) =>
               (celsius + 273.15M) * 1.8M;

            static decimal R2C(decimal rankine) =>
