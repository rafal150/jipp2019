...
namespace Units_Converter
{
    public class StatisticsAzureStorageRepository : IStatisticsRepository
    {
        ...
        public StatisticsAzureStorageRepository()
        {
            ...
            this.table = client.GetTableReference("MaciejPietrzakZ509");
        ...
        public IEnumerable<StatisticsDTO> GetStatistics()
        {
            ...
            return table.ExecuteQuery(query).Select(obj => new StatisticsDTO() { DateTime = obj.DateTime, Type = obj.Type }).ToList();
        }
    }
}
