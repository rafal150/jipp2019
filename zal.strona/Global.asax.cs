...
namespace zal.strona
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        private static IContainer BuildContainer()
        {
            ...
            {
                containerBuilder.RegisterType<StatystykaAzure>().As<IStatisticsRepository>();
            }
            else
            {
            ...
            var assembly = typeof(SerwisConwerterow).Assembly; // Assembly.GetExecutingAssembly();
